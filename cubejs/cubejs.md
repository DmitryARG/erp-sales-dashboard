...
3. Контекст безопасности распространяется через `contextToAppId`
...
3. **Механизмы отката**: Множественные попытки установить контекст безопасности в `contextToAppId`
